...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <a href="<?php echo e(url('welcome')); ?>"><img src="pub/img/Home.png" height="75px" width="220px" alt="" title="" /></img></a>
      ...
      <nav id="nav-menu-container">
        ...
        <?php if(Route::has('login')): ?>
         <?php if(Auth::check()): ?>
          ...
          <li><a href="<?php echo e(url('/login')); ?>">Se Connecter</a></li>
         <?php endif; ?>
        <?php endif; ?> 
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <a href="<?php echo e(url('/login')); ?>" class="btn-get-started">Commencer</a>
    </div>
  </section><!-- #hero -->
