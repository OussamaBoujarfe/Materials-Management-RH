 ...
 <div class="container">
    <div class="row">
        <div class="col-md-12">
           ...
           <form action="<?php echo e(url('employes')); ?>" method="post"> 

                <?php echo e(csrf_field()); ?>


             <div class="form-group <?php if($errors->get('matricule')): ?> has-error <?php endif; ?>">
             ...
             <br><br>
               ...
               <input type="text" name="matricule" class="form-control" value="<?php echo e(old('matricule')); ?>" >
               <?php if($errors->get('matricule')): ?>
             ...
             <div class="form-group <?php if($errors->get('nomc')): ?> has-error <?php endif; ?>">
               <label for="">Nom Complet :</label>
               <input type="text" name="nomc" class="form-control" value="<?php echo e(old('nomc')); ?>">
               <?php if($errors->get('nomc')): ?>
                 <?php $__currentLoopData = $errors->get('nomc'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <li><?php echo e($message); ?></li>
                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php endif; ?>
             </div>

             <div class="form-group <?php if($errors->get('fonction')): ?> has-error <?php endif; ?>">
               <label for="">Fonctionnement :</label>
               <input type="text" name="fonction" class="form-control" value="<?php echo e(old('fonction')); ?>">
               <?php if($errors->get('fonction')): ?>
             ...
             <div class="form-group col-md-4">
               ...
               <select id="inputState" class="form-control" name="departement" value="<?php echo e(old('departement')); ?>">
             ...
             <div class="form-group col-md-4">
               ...
               <select id="inputState" class="form-control" name="etat" value="<?php echo e(old('etat')); ?>">
           ...
           <!--   <a href="<?php echo e(url('materiels')); ?>" type="submit"  class="btn btn-success d">suivant</a>--> 
               <input type="submit" href="<?php echo e(url('employes')); ?>"  class="form-control btn btn-primary" value="Enregistrer"> 
             </div
